...
<img width="1455" height="795" alt="image" src="https://github.com/user-attachments/assets/53f91176-e10f-4c33-893a-41b3f6415775" />

🔹 Payment Method Breakdown
| Payment Method   | Amount  |
| ---------------- | ------- |
| Online Banking   | 359.35K |
| Cash On Delivery | 349.83K |
| Credit Card      | 347.70K |
| Debit Card       | 342.94K |
...
🧠 Key Insights
📉 The delivery rate is relatively low (27%), indicating a need for improvement.
⚖️ Cancelled and returned orders are nearly equal to delivered orders, which is a major concern.
💳 Payment methods are fairly evenly distributed.
📊 Revenue is evenly spread across all quarters.

🚀 Recommendations
🚚 Optimize the delivery process by improving logistics.
